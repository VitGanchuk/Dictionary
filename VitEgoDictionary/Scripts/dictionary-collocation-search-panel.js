                ...
                list.add(header).fadeOut(function () {
                    ...
                    if (data.items.length == 0) {
                        ...
                        for (var i = 0; i < data.items.length; i++) {
                            var item =
                                '<li>' +
                                    '<a href="/Collocation/Item/' + data.items[i].id + '"><span class="index-list-item">' + data.items[i].name + '&nbsp;</span></a>' +
